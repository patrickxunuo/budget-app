-- GH-62: A successful committed sync is the recovery boundary for login repair.
-- Preserve GH-5 account filtering while atomically clearing the repair flag.
-- Plaid returns transactions for every account on an Item, including
...
begin
  ...
  update public.sync_state set
    ...
    needs_login_repair = false, error_code = null, error_message = null,
