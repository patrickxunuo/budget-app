...
Every issue through GH-15 is closed and on `main`. The application is deployed to production at `piggy-budget-app.vercel.app` against a hosted Supabase project and Plaid Sandbox; a real Canadian institution links, activates, and syncs end to end, and the app installs to a home screen. GH-30 (PR #49) and GH-32 (PR #48) are both in review; GH-30 blocks #31. Open and unstarted: #26, #31, #33, #35, and #44.
